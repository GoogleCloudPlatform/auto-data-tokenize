...
public final class RandomGenericRecordGenerator {
  ...
  public static ImmutableList<GenericRecord> generateGenericRecords(int count) {
  ...
  private RandomGenericRecordGenerator() {}
}
