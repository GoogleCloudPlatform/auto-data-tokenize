...
public abstract class DlpIdentify
  ...
  public static DlpIdentify withIdentifierFactory(DlpBatchInspectFactory batchIdentifierFactory) {
  ...
  abstract static class SendToDlp
    ...
    public static SendToDlp create(DlpBatchInspectFactory identifierFactory) {
