...
@AutoValue
public abstract class DlpBatchInspectFactory implements Serializable {
  ...
  public static Builder builder() {
    return new AutoValue_DlpBatchInspectFactory.Builder();
  }
  ...
  public abstract static class Builder {
    ...
    public abstract DlpBatchInspectFactory build();
  }
}
