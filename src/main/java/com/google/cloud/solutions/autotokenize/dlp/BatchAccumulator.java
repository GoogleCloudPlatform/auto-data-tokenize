...
public interface BatchAccumulator<InputT, OutputT> {
  ...
  default ImmutableList<InputT> addAllElements(@Nullable Iterable<InputT> elements) {
    if (elements == null) {
   ...
   */
  default ImmutableList<InputT> addAllElements(@Nullable Iterator<InputT> elements) {
    if (elements == null) {
      return ImmutableList.of();
    }
  ...
  /** Returns the accumulated elements as batch of type {@code OutputT}. */
