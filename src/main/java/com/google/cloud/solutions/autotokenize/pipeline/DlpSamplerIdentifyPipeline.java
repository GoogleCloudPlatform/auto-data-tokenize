...
import com.google.cloud.solutions.autotokenize.datacatalog.ExtractDataCatalogItems;
...
public final class DlpSamplerIdentifyPipeline {
  ...
  private DlpSamplerIdentifyPipeline(DlpSamplerIdentifyOptions options) {
    this(options, Pipeline.create(options), DlpClientFactory.defaultFactory());
  }

  @VisibleForTesting
  DlpSamplerIdentifyPipeline(
      DlpSamplerIdentifyOptions options, Pipeline pipeline, DlpClientFactory dlpClientFactory) {
