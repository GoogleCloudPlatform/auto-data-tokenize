...
public class TokenizeColumnNameUpdater implements Serializable {
  ...
  public FlatRecord updateColumnNames(FlatRecord record) {
    return new RecordColumnNameUpdater(tokenizeSchemaKeys, record).update();
  }

  public RecordColumnNameUpdater updaterFor(FlatRecord record) {
    return new RecordColumnNameUpdater(tokenizeSchemaKeys, record);
  }
  ...
  public static class RecordColumnNameUpdater implements Serializable {
    ...
    public RecordColumnNameUpdater(ImmutableSet<String> tokenizeSchemaKeys, FlatRecord record) {
      ...
      this.record = record;
      this.flatKeySchemaKey = ImmutableMap.copyOf(record.getFlatKeySchemaMap());
    }
