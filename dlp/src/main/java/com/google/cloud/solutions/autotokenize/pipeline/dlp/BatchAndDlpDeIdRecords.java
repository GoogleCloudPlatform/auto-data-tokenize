...
public abstract class BatchAndDlpDeIdRecords extends PTransform<PCollection<FlatRecord>, PCollection<FlatRecord>> {
  ...
  private static class PartialColumnBatchAccumulatorFactory
    ...
    public PartialColumnBatchAccumulatorFactory(DlpEncryptConfig encryptConfig) {
      this.encryptConfig = encryptConfig;
    }

    @Override
    public BatchAccumulator<FlatRecord, PartialColumnDlpTable> newAccumulator() {
      return PartialColumnBatchAccumulator.withConfig(encryptConfig);
    }
  }
