...
public final class RandomColumnarSamplerTest {
  ...
  public void expand_valid() {
    PCollection<KV<String, Iterable<Value>>> sampledColumns =
        testPipeline
            .apply(Create.of(flatRecords))
            .apply(RandomColumnarSampler.any(sampleSize));
  ...
  private static class ColumnValuesChecker implements
      SerializableFunction<Iterable<KV<String, Iterable<Value>>>, Void> {
    ...
    public Void apply(Iterable<KV<String, Iterable<Value>>> columnValuesPcollection) {
      columnValuesPcollection.forEach(column -> {
    ...
    return ImmutableList.<Object[]>builder()
        .add(new Object[]{
            ...
            FlatRecord.newBuilder()
                ...
                .putValues("$.cc[2]", Value.newBuilder().setIntegerValue(1212343456567878L).build())
                .build()
        ),
            /*expectedSplits=*/ ImmutableMap.<String, ImmutableSet<Value>>builder()
            .put("$.cc", ImmutableSet.of(
        ...
        .add(new Object[]{
            ...
            /*sampleSize=*/ 100,
            /*flatRecords=*/
            TestResourceLoader.classPath().forProto(FlatRecord.class)
                .loadAllTextFiles(
                ImmutableList.of(
